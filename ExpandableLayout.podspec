Pod::Spec.new do |s|
  ...
  Expand or collapse sections of UICollectionView.
                       DESC
  s.homepage         = 'https://github.com/touchlane/ExpandableLayout'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Touchlane LLC' => 'tech@touchlane.com' }
  s.source           = { :git => 'https://github.com/touchlane/ExpandableLayout.git', :tag => s.version.to_s }
